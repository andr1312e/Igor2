...
public:
    ...
    ~TrayMenu();
public Q_SLOTS:
    void OnUpdateViewColors(ThemesNames themeName);
private Q_SLOTS:
...
private:
    void SetStyleToButton(InteractiveButton *button);
private:
...
private://Анимация показа
    ...
    QParallelAnimationGroup *AnimateExpansionOfAllButtons();
