...
void ConclusionWizardPage::initializePage()
{
    ...
    {
        m_backupValue->setText(QStringLiteral("файл восстановления отсутствует"));
    }
...
void ConclusionWizardPage::CreateUI()
{
    ...
    m_backupLabel = new QLabel(QStringLiteral("Файл восстановления: "));
...
void ConclusionWizardPage::InsertWidgetsIntoLayout()
{
    ...
    MainLayout()->addWidget(m_actionsLabel, 0, Qt::AlignHCenter);
    ...
    m_dataLayout->setContentsMargins(40, 0, 40, 0);
    ...
    MainLayout()->addWidget(m_needInstallPackages, 0, Qt::AlignCenter);
    ...
    MainLayout()->addLayout(m_installingPackesLayout, 1);
