...
static const std::array<QString,4> RolesToolTip={     "Просмотр базы данных недоступен. Доступны только базовые возможности",
...
static const std::array<QString,18>  RanksICO={ ":/images/Звания/Рядовой",
