...
QT_MOC_LITERAL(4, 39, 17) // "roleToViewChanged"
    ...
    "SettingsPanel\0setDefaultRoleApps\0\0"
    "role\0roleToViewChanged"
};
...
void SettingsPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsPanel::setDefaultRoleApps)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SettingsPanel::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsPanel::roleToViewChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SettingsPanel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SettingsPanel.data,
      qt_meta_data_SettingsPanel,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void SettingsPanel::setDefaultRoleApps(const QString & _t1)
{
...
// SIGNAL 1
void SettingsPanel::roleToViewChanged(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
